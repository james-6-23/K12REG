...
def build_credentials(
    ...
    # Backfill id_token claims if needed
    if id_token and (not chatgpt_account_id or not chatgpt_user_id):
        id_token = backfill_id_token_claims(
            id_token,
            chatgpt_account_id=chatgpt_account_id,
            account_id=chatgpt_user_id,
        )
...
def export_sub2api_json(
    ...
    Returns:
        JSON string of the sub2api bundle
    """
